...
probs_no_avc = gerar_probs_node_avc('stroke.csv')
...
hipertensao = BbnNode(Variable(2,'hipertensao', ['true','false']), [probs_nos_perifericos[2],probs_nos_perifericos[3]])
doenca_card = BbnNode(Variable(3,'doenca', ['true','false']), [probs_nos_perifericos[4],probs_nos_perifericos[5]])
tabagismo = BbnNode(Variable(4,'fuma-ja-fumou', ['true','false']), [probs_nos_perifericos[6],probs_nos_perifericos[7]])
imc = BbnNode(Variable(5,'peso-abaixo-ideal', ['true','false']), [probs_nos_perifericos[8],probs_nos_perifericos[9]])
glicose = BbnNode(Variable(6,'hipoglicemia-normal', ['true','false']), [probs_nos_perifericos[10],probs_nos_perifericos[11]])
idade = BbnNode(Variable(7,'jovem-adulto', ['true','false']), [probs_nos_perifericos[12],probs_nos_perifericos[13]])
